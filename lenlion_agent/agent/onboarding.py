...
def openclaw_residue_hint_cli() -> str:
    ...
    Points users at ``lenlion claw migrate`` (non-destructive port of config,
    memory, and skills) first. ``lenlion claw cleanup`` is mentioned as the
    ...
    return (
        ...
        "`lenlion claw migrate`.\n"
        "If you've already migrated and want to archive the old directory, "
        "run `lenlion claw cleanup` (renames it to ~/.openclaw.pre-migration — "
