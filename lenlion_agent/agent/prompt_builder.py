...
KANBAN_GUIDANCE = (
    ...
    "## Do NOT\n"
    "\n"
    "- Do not shell out to `lenlion kanban <verb>` for board operations. Use "
...
def build_environment_hints() -> str:
    ...
    # marks a lenlion launched in the embedded terminal pane. Both set by main.cjs.
    _truthy = ("1", "true", "yes")
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "first. It has the actual commands (e.g. `lenlion config set …`, `lenlion tools`, "
            "`lenlion setup`) so you don't have to guess or invent workarounds.\n"
...
def build_nous_subscription_prompt(valid_tool_names: "set[str] | None" = None) -> str:
    ...
    lines.extend(
        [
            ...
            "Useful commands: lenlion setup, lenlion setup tools, lenlion setup terminal, lenlion status.",
        ]
    )
    return "\n".join(lines)
