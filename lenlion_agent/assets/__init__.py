...
Cron jobs are executed automatically by the gateway daemon:
    lenlion gateway install    # Install as a user service
    sudo lenlion gateway install --system  # Linux servers: boot-time system service
    lenlion gateway            # Or run in foreground
