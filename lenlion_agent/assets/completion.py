"""Shell completion script generation for lenlion CLI.
...
complete -F _hermes_completion lenlion
"""
...
def generate_zsh(parser: argparse.ArgumentParser) -> str:
    ...
    return f"""#compdef lenlion
# Hermes Agent zsh completion
# Add to ~/.zshrc:
#   eval "$(lenlion completion zsh)"
...
{top_cmds_str}
            ...
            _describe 'lenlion command' subcmds
            ;;
        args)
            case ${{line[1]}} in
{sub_cases_str}
...
def generate_fish(parser: argparse.ArgumentParser) -> str:
    ...
    lines: list[str] = [
        ...
        "# Add to your config:",
        "#   lenlion completion fish | source",
        "",
        ...
        "complete -c lenlion -f",
        "",
        "# Complete profile names after -p / --profile",
        "complete -c lenlion -f -s p -l profile"
