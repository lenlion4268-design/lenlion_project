"""Tests for `lenlion fallback` — chain reading, add/remove/clear, legacy migration."""
...
class TestListCommand:
    def test_list_empty(self, isolated_home, capsys):
        ...
        assert "lenlion fallback add" in out
...
class TestArgparseWiring:
    """Verify `lenlion fallback` is wired into main.py's argparse tree.
