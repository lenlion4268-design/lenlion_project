...
class TestGatewayLifecyclePattern:
    ...
    @pytest.mark.parametrize("text", [
        "lenlion gateway restart",
        "lenlion gateway stop",
        "lenlion gateway start",
        "lenlion  gateway  restart",         # double spaces
    ...
    @pytest.mark.parametrize("text", [
        ...
        "lenlion cron list",
        "lenlion update",
        "lenlion config set model claude",
...
class TestCronCreateLifecycleBlock:
    ...
    def test_block_hermes_gateway_restart(self, capsys):
        args = Namespace(
            cron_command="create",
            schedule="30m",
            prompt="Upgrade lenlion then run lenlion gateway restart",
            name=None,
            deliver=None,
            repeat=None,
            skill=None,
...
class TestGatewaySelfTargetingGuard:
    """Verify lenlion gateway stop/restart refuse when _HERMES_GATEWAY=1."""
