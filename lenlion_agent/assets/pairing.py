...
Usage:
    lenlion pairing list              # Show all pending + approved users
    lenlion pairing approve <platform> <code>  # Approve a pairing code
    lenlion pairing revoke <platform> <user_id> # Revoke user access
    lenlion pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle lenlion pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: lenlion pairing {list|approve|revoke|clear-pending}")
        print("Run 'lenlion pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'lenlion pairing list' to see pending codes.\n")
