...
def check_requirements() -> bool:
    ...
    # lenlion setup / requirements check path.
...
def interactive_setup() -> None:
    """Interactive `lenlion gateway setup` flow for the IRC platform.
    ...
    channel = prompt(
        "Channel to join (e.g. #lenlion — comma-separate for multiple)",
    ...
    print_info("Restart the gateway for changes to take effect: lenlion gateway restart")
