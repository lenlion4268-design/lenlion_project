 ...
 *
 * Symptom: in `lenlion --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@lenlion/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using lenlion --tui and as i type multiline my caret at the end will often ' +
