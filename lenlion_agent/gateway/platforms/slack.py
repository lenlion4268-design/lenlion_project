...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # manifest (see `lenlion slack manifest`). In Socket Mode, Slack
    ...
    async def _handle_slack_message(self, event: dict) -> None:
        ...
        if original_text.startswith("!"):
            try:
                ...
                # forms like ``!stop@lenlion`` still resolve.
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        if slash_name in {"lenlion", "hermes", ""}:
            # Legacy /lenlion and /hermes <subcommand> [args] routing + free-form questions.
