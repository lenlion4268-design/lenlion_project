...
MIGRATION_MARKER = (
    "# managed by hermes-agent — `lenlion codex-runtime migrate` regenerates this section"
)
...
def _build_hermes_tools_mcp_entry() -> dict:
    ...
    so a lenlion installed under /opt/, /usr/local/, or a venv all work.
    ...
    # PYTHONPATH passes through so a worktree-launched lenlion finds the
