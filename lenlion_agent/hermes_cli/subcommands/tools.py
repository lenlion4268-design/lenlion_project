"""``lenlion tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'lenlion tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # lenlion tools list [--platform cli]
    ...
    # lenlion tools disable <name...> [--platform cli]
    ...
    # lenlion tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `lenlion tools` runs after you pick a provider that\n"
