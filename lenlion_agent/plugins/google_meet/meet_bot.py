...
``$HERMES_HOME/workspace/meetings/<meeting-id>/``. The main lenlion process
...
def _looks_like_human_speaker(speaker: str, bot_guest_name: str) -> bool:
    ...
    bot_names = {"hermes agent", "lenlion agent", bot_guest_name.strip().lower()}
    if spk in {"unknown", "you", *bot_names}:
        return False
    return True
