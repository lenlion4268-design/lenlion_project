...
``_check_spotify_available()`` — when the user has not run ``lenlion auth
spotify``, the tools remain registered (so they appear in ``lenlion
...
The Spotify auth flow (``lenlion auth spotify``), CLI plumbing, and docs
