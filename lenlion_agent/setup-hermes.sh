...
# ============================================================================
# PATH setup — symlink lenlion into a user-facing bin dir
# ============================================================================

echo -e "${CYAN}→${NC} Setting up lenlion command..."
...
echo -e "${GREEN}✓${NC} Symlinked lenlion → $COMMAND_LINK_DISPLAY_DIR/hermes"
...
echo "Other commands:"
echo "  lenlion status        # Check configuration"
if is_termux; then
    echo "  lenlion gateway       # Run gateway in foreground"
else
    echo "  lenlion gateway install # Install gateway service (messaging + cron)"
fi
echo "  lenlion cron list     # View scheduled jobs"
echo "  lenlion doctor        # Diagnose issues"
echo ""
