...
class TestCmdUpdateBranchFlag:
    """``lenlion update --branch <name>`` targets the requested branch.
...
class TestCmdUpdateCheckBranchFlag:
    """``lenlion update --check --branch <name>`` honors the branch override.
...
class TestCmdUpdateZipBranchRefusal:
    """``lenlion update --branch=<non-main>`` must refuse on the ZIP fallback path.
