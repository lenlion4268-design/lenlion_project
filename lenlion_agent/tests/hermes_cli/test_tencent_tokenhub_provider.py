...
# =============================================================================
# CANONICAL_PROVIDERS (lenlion model picker)
# =============================================================================
...
class TestTencentTokenhubDoctor:
    """Verify lenlion doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``lenlion model`` routes it through the generic api_key_provider flow.
        """
        import inspect
