...
class TestHermesConfigWriteProtection:
    ...
    def test_sed_in_place(self):
        ...
        assert dangerous is True
        assert "lenlion config" in desc.lower() or "in-place" in desc.lower()
...
class TestGatewayProtection:
    ...
    def test_pkill_hermes_detected(self):
        """pkill targeting lenlion/gateway processes must be caught."""
...
class TestPgrepKillExpansion:
    """kill -9 $(pgrep lenlion) bypasses the pkill/killall name-matching
