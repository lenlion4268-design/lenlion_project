...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `lenlion tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    "video_gen": {
        "description": (
            ...
            "``lenlion tools`` → Video Generation."
        ),
    ...
    # the `lenlion send` CLI), not by the model deciding to send on its own.
    # ==========================================================================
    ...
    "hermes-cron": {
        ...
        # core tools users see interactively — then `lenlion tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as hermes-cli; gated by `lenlion tools`",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
